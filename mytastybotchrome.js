...
(function() {
    if (!requirejs.defined('ce221/a82cc/b5033'))
        return API.chatLog('This version of plug&#179; is not compatible with this version of plug.dj', true), false;

    define('f82fae/b93191', ['jquery', 'underscore', 'ce221/a82cc/b5033', 'ce221/a82cc/a42d7', 'ce221/f5c01/a983c', 'ce221/fff6a/a8ab5', 'ce221/bbc3c/ecebe', 'ce221/d7639/ba046', 'ce221/a44b3/f19a3', 'ce221/a44b3/a1ac7', 'ce221/bbc3c/c636a', 'lang/Lang', 'ce221/df202/bd7f7/d51d6', 'f82fae/a07c86', 'ce221/df202/bd7f7/e27dd/f1f3f', 'ce221/df202/bd7f7/e27dd/fd793', 'f82fae/f36e0e', 'f82fae/f1da31', 'f82fae/ac606c', 'ce221/b0533/e5fad', 'ce221/bbc3c/f6ff1', 'f82fae/d67453/c8e8fc', 'f82fae/a8c196', 'f82fae/abd868', 'f82fae/d67453/a1ab3a', 'ce221/df202/bd7f7/bc67e/e39c3', 'ce221/df202/e27dd/b9891'], function($, _, Class, Context, Chat, Utils, Room, MGE, Socket, SocketListner, TUM, Lang, Audience, Styles, RoomUserListView, RoomUserListRow, _RoomUserListRow, p3Lang, p3Utils, Database, PlaybackModel, dialogCommands, Slider, VolumeView, dialogColors, PopoutView, UserRolloverView) {
        ...
        return Class.extend({
            ...
            close: function() {
                ...
                if (socket) {
                    socket.onclose = function() {
                        console.log('[plugA? Socket Server]', 'Closed');
                    };
                    socket.close();
                }
            ...
            Socket: function() {
                ...
                socket.tries = 0;
                console.log('[plugA? Socket Server]', socketReconnecting ? 'Reconnecting' : 'Connecting');
                /**
                 * @this {SockJS}
                 */
                socket.onopen = function() {
                    this.tries = 0;
                    console.log('[plugA? Socket Server]', socketReconnecting ? 'Reconnected' : 'Connected');
    ...
    define('f82fae/d67453/a1ab3a', ['jquery', 'ce221/a82cc/b5033', 'lang/Lang', 'ce221/a82cc/a42d7', 'f82fae/f1da31'], function($, b, c, d, p3Lang) {
    ...
    define('f82fae/d67453/f0dff5', ['jquery', 'ce221/df202/f69eb/ad389', 'lang/Lang', 'ce221/a82cc/b5033', 'ce221/a82cc/a42d7', 'ce221/d7639/f860e', 'f82fae/f1da31'], function($, b, c, d, e, f, p3Lang) {
        var a = d.extend({
            init: function(id) {
    ...
    define('f82fae/d67453/c8e8fc', ['jquery', 'ce221/a82cc/b5033', 'lang/Lang', 'f82fae/f1da31', 'f82fae/ac606c'], function($, b, c, p3Lang, p3Utils) {
        var userCommands = [
    ...
    define('f82fae/a07c86', ['jquery', 'ce221/a82cc/b5033'], function($, Class) {
        var obj,
            styles = {},
            update = function() {
                var a = '';
    ...
    define('f82fae/ac606c', ['ce221/a82cc/b5033', 'ce221/df202/bd7f7/bc67e/e39c3', 'f82fae/f1da31'], function(Class, PopoutView, p3Lang) {
    ...
    define('f82fae/f36e0e', ['jquery', 'ce221/df202/bd7f7/e27dd/b7ead', 'f82fae/f1da31', 'f82fae/ac606c', 'ce221/a82cc/a42d7'], function($, RoomUserListRow, p3Lang, p3Utils, Context) {
    ...
    define('f82fae/f1da31', ['jquery', 'ce221/a82cc/b5033'], function($, Class) {
        var language = {},
            isLoaded = false,
            Lang = Class.extend({
                init: function() {
    ...
    define('f82fae/a8c196', ['jquery', 'ce221/a82cc/b5033'], function($, Class) {
        return Class.extend({
    ...
    define('f82fae/e78de6', ['jquery', 'ce221/a82cc/b5033', 'f82fae/b93191', 'ce221/df202/f69eb/ad389', 'f82fae/f1da31', 'f82fae/ac606c'], function($, Class, Model, ADV, p3Lang, p3Utils) {
    ...
    */
    define('f82fae/abd868', ['jquery', 'underscore', 'ce221/df202/bd7f7/d1409/bc88b', 'ce221/bbc3c/f6ff1', 'hbs!templates/room/playback/Volume', 'ce221/a82cc/a42d7', 'f82fae/f1da31'], function($, e, original, r, s, Context, p3Lang) {
